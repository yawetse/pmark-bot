...
def test_req_obs_005_tick_summary_retries_with_low_cost_fallback_model(monkeypatch) -> None:
    ...
    Then: the summary retries with the fallback without recording a recovered failure as an APM error
    """
...
def test_req_obs_005_tick_summary_marks_error_after_all_fallbacks_fail(monkeypatch) -> None:
    ...
    Then: only the final attempt is recorded as an APM error
    """
