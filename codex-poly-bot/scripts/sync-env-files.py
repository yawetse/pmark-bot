...
ORDERED_KEYS = (
    ...
    "POLYMARKET_ORDER_BOOK_RETRIES",
    "POLYMARKET_ORDER_BOOK_RETRY_BACKOFF_SECONDS",
    "POLYMARKET_ORDER_BOOK_CONCURRENCY",
    "POLYMARKET_ORDER_BOOK_CACHE_TTL_SECONDS",
    "KALSHI_ENVIRONMENT",
    ...
    "OPENAI_API_KEY",
    "OPENAI_TICK_SUMMARY_MODEL",
    "OPENAI_TICK_SUMMARY_FALLBACK_MODEL",
...
DEFAULTS: dict[str, OrderedDict[str, str]] = {
    "local": OrderedDict(
        (
            ...
            ("KALSHI_MARKET_ORDER_SLIPPAGE", "0.02"),
            ...
            ("POLYMARKET_ORDER_BOOK_RETRIES", "2"),
            ("POLYMARKET_ORDER_BOOK_RETRY_BACKOFF_SECONDS", "0.25"),
            ("POLYMARKET_ORDER_BOOK_CONCURRENCY", "4"),
            ("POLYMARKET_ORDER_BOOK_CACHE_TTL_SECONDS", "300"),
            ("KALSHI_MARKET_DATA_LIMIT", "100"),
            ("KALSHI_MARKET_PAGE_SIZE", "100"),
            ("KALSHI_READ_RETRIES", "2"),
            ("KALSHI_RETRY_BACKOFF_SECONDS", "0.25"),
            ...
            ("DASHBOARD_TRUSTED_ORIGINS", "http://localhost:3100,http://127.0.0.1:3100"),
            ...
            ("OPENAI_TICK_SUMMARY_TIMEOUT_SECONDS", "60"),
            ("ANTHROPIC_API_KEY", ""),
            ("POLYMARKET_KEY_ID", ""),
            ("POLYMARKET_SECRET_KEY", ""),
            ("POLYMARKET_PRIVATE_KEY", ""),
...
PATH_KEY_MAP = {
    ...
    "polymarket_us/openai/key-id": "POLYMARKET_OPENAI_KEY_ID",
    "polymarket_us/openai/api-key-id": "POLYMARKET_OPENAI_KEY_ID",
    "polymarket_us/openai/secret-key": "POLYMARKET_OPENAI_SECRET_KEY",
    "polymarket_us/openai/api-secret": "POLYMARKET_OPENAI_SECRET_KEY",
    "polymarket_us/openai/private-key": "POLYMARKET_OPENAI_PRIVATE_KEY",
    "polymarket_us/claude/key-id": "POLYMARKET_CLAUDE_KEY_ID",
    "polymarket_us/claude/api-key-id": "POLYMARKET_CLAUDE_KEY_ID",
    "polymarket_us/claude/secret-key": "POLYMARKET_CLAUDE_SECRET_KEY",
    "polymarket_us/claude/api-secret": "POLYMARKET_CLAUDE_SECRET_KEY",
    "polymarket_us/claude/private-key": "POLYMARKET_CLAUDE_PRIVATE_KEY",
    "kalshi/market-data/key-id": "KALSHI_MARKET_DATA_KEY_ID",
    "kalshi/market-data/private-key": "KALSHI_MARKET_DATA_PRIVATE_KEY",
    "kalshi/openai/key-id": "KALSHI_OPENAI_KEY_ID",
    "kalshi/openai/private-key": "KALSHI_OPENAI_PRIVATE_KEY",
    "kalshi/claude/key-id": "KALSHI_CLAUDE_KEY_ID",
    "kalshi/claude/private-key": "KALSHI_CLAUDE_PRIVATE_KEY",
    ...
    "alpaca/openai/key-id": "ALPACA_OPENAI_KEY_ID",
    "alpaca/openai/api-key-id": "ALPACA_OPENAI_KEY_ID",
    "alpaca/openai/secret-key": "ALPACA_OPENAI_SECRET_KEY",
    "alpaca/openai/api-secret": "ALPACA_OPENAI_SECRET_KEY",
    "alpaca/claude/key-id": "ALPACA_CLAUDE_KEY_ID",
    "alpaca/claude/api-key-id": "ALPACA_CLAUDE_KEY_ID",
    "alpaca/claude/secret-key": "ALPACA_CLAUDE_SECRET_KEY",
    "alpaca/claude/api-secret": "ALPACA_CLAUDE_SECRET_KEY",
