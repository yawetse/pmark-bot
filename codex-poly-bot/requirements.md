...
| REQ-UI-004 | P0 | The dashboard shall allow authorized users to view venue, model, wallet, ingestion, trading loop, position, order, and notification status. |
...
| REQ-UI-007 | P0 | When dashboard configuration is saved, the system shall apply the change on the next trading loop without restart. |
