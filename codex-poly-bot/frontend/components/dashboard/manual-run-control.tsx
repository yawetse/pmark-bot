...
const RUN_MODES: {
  ...
  },
  {
    mode: "scanner_only",
    label: "Filters only",
    title: "Fetch data and run market filters",
  ...
  },
  {
    ...
    detail: "Runs data, market filters, model scoring, strategy, and simulated execution.",
    risk: "medium",
  },
  {
    mode: "full_live_gated",
    label: "Live-gated cycle",
    title: "Run all five steps using configured live gates",
    detail: "Uses live gates, venue flags, credentials, risk limits, and emergency-stop state.",
    risk: "gated",
  },
];
